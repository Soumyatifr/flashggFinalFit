...
def getSystLabelsWeights(isMET = False, is2018 = False):
    ...
    for direction in ["Up","Down"]:
     ...
     #   phosystlabels.append("MCScaleGain1EB%s01sigma" % direction)
        jetsystlabels.append("JECAbsolute%s01sigma" % direction)
        jetsystlabels.append("JECAbsolute2018%s01sigma" % direction)
        jetsystlabels.append("JECBBEC1%s01sigma" % direction)
        jetsystlabels.append("JECBBEC12018%s01sigma" % direction)
        jetsystlabels.append("JECEC2%s01sigma" % direction)
        jetsystlabels.append("JECEC22018%s01sigma" % direction)
        jetsystlabels.append("JECFlavorQCD%s01sigma" % direction)
        jetsystlabels.append("JECHF%s01sigma" % direction)
        jetsystlabels.append("JECHF2018%s01sigma" % direction)
        jetsystlabels.append("JECRelativeBal%s01sigma" % direction)
        jetsystlabels.append("JECRelativeSample2018%s01sigma" % direction)
    ...
    systweights = [ "PreselSF", "electronVetoSF", "TriggerWeight", "FracRVWeight",  "MuonIDWeight", "MuonIsoWeight", "ElectronIDWeight", "ElectronRecoWeight", "JetBTagReshapeWeightJES","JetBTagReshapeWeightLF","JetBTagReshapeWeighthfstats1","JetBTagReshapeWeighthfstats2","JetBTagReshapeWeightHF","JetBTagReshapeWeightlfstats1","JetBTagReshapeWeightlfstats2"]
    if not is2018 :
...
def get_options():
    ...
    parser = OptionParser()
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='thq,qqh,vh,ggh,tth')  
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='qqHH_CV_1_C2V_0_kl_1,qqHH_CV_1p5_C2V_1_kl_1')  
    #parser.add_option("--inp-files",type='string',dest='inp_files',default='qqHH_CV_1_C2V_1_kl_1,qqHH_CV_1_C2V_2_kl_1,qqHH_CV_1_C2V_1_kl_2,qqHH_CV_1_C2V_1_kl_0,qqHH_CV_1_C2V_0_kl_1,qqHH_CV_1p5_C2V_1_kl_1')
    parser.add_option("--inp-files",type='string',dest='inp_files',default='hh_nlo_cHHH0,hh_nlo_cHHH1,hh_nlo_cHHH2p45,hh_nlo_cHHH5')  
    parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/eos/user/m/mukherje/HH_bbgg/combine_HH/Flattrees/')
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/eos/user/m/mukherje/HH_bbgg/combine_HH/workspace/')
    ...
    parser.add_option("--config",type='string',dest="config",default='../MetaData_HHbbgg/reweighting_normalization_18_12_2019.json')
    parser.add_option("--btag_config",type='string',dest="btag_config",default='../MetaData_HHbbgg/btagSF_22_04_2020_combine.json')
    parser.add_option("--LHEweight_rescale",type='string',dest="LHEweight_rescale",default='../MetaData_HHbbgg/HH_NLO_gen_xsec_22_04_2020.json')
